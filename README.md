...
v0.4.0 新增视频工坊，可测试 OpenAI 风格的视频生成接口和部分即梦反代使用的聊天兼容接口，支持文生视频、首尾帧与全能参考、结果预览、任务信息和原始响应查看。原有图片、文本、双引擎与局域网能力保持不变。
...
完整变更与安装注意事项见 [v0.4.0 发布说明](RELEASE_NOTES.md)。
